...
void ubah(int x){
	int a,b,c;
	cout<<"jenis-jenis operasi: "<<endl;
	cout<<"1. memasukkan data"<<endl;
	cout<<"2. menghapus data"<<endl;
	cout<<"3. exit"<<endl;
	cout<<"pilih operasi yang diinginkan : "; cin>>a;
	...
	if(a==1){
		...
		cout<<"masukkan koefesien dan pangkat yang akan dihapus :"<<endl;
		cout<<"koefesien : "; cin>>b;
		cout<<"pangkat : "; cin>>c;
		p[x].hapus(b,c);
	} else if (a==3) {
...
int main(){
	...
	do{
	cout<<"polinom yang akan dioperasikan:"<<endl;
	cout<<"1. P1"<<endl;
	cout<<"2. P2"<<endl;
	cout<<"3. P3"<<endl;
	cout<<"4. exit"<<endl;
	cout<<"pilih polinom : "; cin>>a;
	ubah(a-1);cout<<endl;
	cout<<"P1 = ";p[0].print();
	cout<<"P2 = ";p[1].print();
	cout<<"P3 = ";p[2].print();
